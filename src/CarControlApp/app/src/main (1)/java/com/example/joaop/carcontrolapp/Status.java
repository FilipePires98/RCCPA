...
public class Status extends AppCompatActivity implements View.OnClickListener{
    ...
    public void notificationCall(){
        NotificationCompat.Builder mBuilder =new NotificationCompat.Builder(this)
                ...
                .setSmallIcon(R.drawable.alertas)
                .setContentTitle("Novos Alertas!!")
                .setContentText("Consultar Estado.")
                .setAutoCancel(true)
                .setPriority(NotificationCompat.PRIORITY_DEFAULT);

        Intent aint = new Intent(this, Status.class);
        aint.putExtra("notific",1);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.info:
                startActivity(new Intent(this, AjudaStatus.class));
                break;
