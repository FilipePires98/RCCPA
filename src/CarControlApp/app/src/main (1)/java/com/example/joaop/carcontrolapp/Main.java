...
public class Main extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener{
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.info:
                startActivity(new Intent(this, AjudaMain.class));
                break;
            ...
            case R.id.alertfronthood:
                ...
                msg=Toast.makeText(this, "Capô aberto/destrancado.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
            ...
            case R.id.alertrightfront:
                ...
                msg=Toast.makeText(this, "Porta do pendura aberta/destrancada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            case R.id.alertleftfront:
                ...
                msg=Toast.makeText(this, "Porta do condutor aberta/destrancada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            case R.id.alertrightback:
                ...
                msg=Toast.makeText(this, "Porta aberta/destrancada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            ...
            case R.id.alerttrunk:
                ...
                msg=Toast.makeText(this, "Mala do carro aberta/destrancada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            case R.id.alertrightbacklight:
                ...
                msg=Toast.makeText(this, "Luz traseira direita danificada/ligada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            case R.id.alertrightfrontlight:
                ...
                msg=Toast.makeText(this, "Luz dianteira direita danificada/ligada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            case R.id.alertleftbacklight:
                ...
                msg=Toast.makeText(this, "Luz traseira esquerda danificada/ligada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            case R.id.alertleftfrontlight:
                ...
                msg=Toast.makeText(this, "Luz dianteira esquerda danificada/ligada.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            case R.id.alertfuel:
                if(msg != null){
                ...
                msg=Toast.makeText(this, "Tampa do depósito aberta.\nDirija-se aos Controlos.", Toast.LENGTH_SHORT);
                msg.show();
                break;
            ...
            case R.id.acOn:
                ...
                msg=Toast.makeText(this, "Ar Condicionado ligado.\nDirija-se ao Ar Condicionado.", Toast.LENGTH_SHORT);
                msg.show();
                break;
