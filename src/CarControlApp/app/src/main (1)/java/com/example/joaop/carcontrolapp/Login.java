...
public class Login extends AppCompatActivity {
    ...
    private void validate(String userUsername, String userPassword) {
        ...
        if(userUsername.equals(USER) && userPassword.equals(PASS)) {
            ...
            loginAttempts.setText(String.valueOf(attempts) + " tentativa(s) restante(s).");

            if(attempts == 0) {
                loginAttempts.setText("Sem mais tentativas restantes.\nPorfavor contacte a empresa do seu automóvel.");
