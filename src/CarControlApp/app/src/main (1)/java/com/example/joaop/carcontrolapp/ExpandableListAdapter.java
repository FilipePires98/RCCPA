        ...
        switch (v.getId()){
            case R.id.fdd:
                ...
                if(Main.rightfrontlight==1){
                    msgE= Toast.makeText(this.context, "Farol Ligado.", Toast.LENGTH_SHORT);
                }else{
                    msgE= Toast.makeText(this.context, "Farol Desligado.", Toast.LENGTH_SHORT);
                }
                msgE.show();
                break;
            case R.id.fdt:
            ...
            case R.id.mala:
                ...
                if(Main.trunk==1){
                    msgE= Toast.makeText(this.context, "Mala Aberta.", Toast.LENGTH_SHORT);
                }else{
                    msgE= Toast.makeText(this.context, "Mala Fechada.", Toast.LENGTH_SHORT);
                }
                msgE.show();
                break;
            case R.id.capo:
                ...
                if(Main.fronthood==1){
                    msgE= Toast.makeText(this.context, "Capô Aberto.", Toast.LENGTH_SHORT);
                }else{
                    msgE= Toast.makeText(this.context, "Capô Fechado.", Toast.LENGTH_SHORT);
                }
                msgE.show();
                break;
            case R.id.pdd:
                ...
                if(Main.rightfront==1){
                    msgE= Toast.makeText(this.context, "Porta Aberta.", Toast.LENGTH_SHORT);
                }else{
                    msgE= Toast.makeText(this.context, "Porta Fechada.", Toast.LENGTH_SHORT);
                }
                msgE.show();
                break;
            case R.id.pdt:
